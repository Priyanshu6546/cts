	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item active"><a href="#" class="nav-link">Admin</a></li>
            <li class="nav-item"><a href="./admview.php" class="nav-link">View</a></li>
			  <li class="nav-item"><a href="./adm.php" class="nav-link">Admin controls</a></li>
...
$cvv=$_POST["cvv"];
$p="Valid";
$sql="UPDATE cusinfo SET cstatus = '$p',climit = '$cl',cvv='$cvv' WHERE cid = $id";
